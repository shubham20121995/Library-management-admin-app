...
public class updatebookRequest {
    ...
    public updatebookRequest(String book_id, String author, String book_name, String publication
            , String edition, String no_of_copies, String date_pur, String price) {
        this.book_id = book_id;
        this.author = author;
        this.book_name = book_name;
        this.publication = publication;
